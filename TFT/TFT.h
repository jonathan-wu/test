...
#define LCD_RS_0  P2OUT &=~BIT1   //数据/命令切换
#define LCD_RS_1  P2OUT |= BIT1
#define LCD_WR_0  P2OUT &=~BIT2	  //写控制
#define LCD_WR_1  P2OUT |= BIT2
#define LCD_RD_0  P2OUT &=~BIT3   //读控制
#define LCD_RD_1  P2OUT |= BIT3
#define LCD_CS_0  P2OUT &=~BIT4   //片选	
#define LCD_CS_1  P2OUT |= BIT4
#define LCD_REST_0  P2OUT &=~BIT5 //复位   
